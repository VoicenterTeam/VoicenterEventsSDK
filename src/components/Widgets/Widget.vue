...
export default {
    ...
    computed: {
        ...
        getFooterStyles() {
            const titleFontSize = parseInt(this.widgetGroupTitleFontSize)
            const margin = titleFontSize > 32 ? `${(titleFontSize - 32) * 2}px` : 'auto'
        ...
        widgetGroupTitleFontSize() {
            const styles = this.$store.getters['layout/widgetGroupTitleStyles']
