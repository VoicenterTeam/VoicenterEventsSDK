...
(function() {
    ...
    $R.add('module', 'editor', {
        ...
        _buildAccesibility: function()
        {
            ...
            setTimeout(() => {
                this._setVariablesInEditor($editor)
            })
        },
        ...
        _setVariablesInEditor: function(editor) {
            if (!this.app.opts.availableVariables || !this.app.opts.availableVariables.length) {
                return
            }
    ...
    $R.add('class', 'modal.element', {
        ...
        {
            // check if it close node or child element of close node
            let target = el
            while(target != undefined && target != null && target !== document) {
                if(target === this.$modalClose.get()) {
                    return true
                }
        ...
        _buildClose: function()
        {
            ...
            this.$modalClose.append(`<svg viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M2.82024 1.17976C2.36724 0.726748 1.63276 0.726748 1.17976 1.17976C0.726748 1.63276 0.726748 2.36724 1.17976 2.82024L2.82024 1.17976ZM14.1798 15.8202C14.6328 16.2733 15.3672 16.2733 15.8202 15.8202C16.2733 15.3672 16.2733 14.6328 15.8202 14.1798L14.1798 15.8202ZM15.8202 2.82024C16.2733 2.36724 16.2733 1.63276 15.8202 1.17976C15.3672 0.726748 14.6328 0.726748 14.1798 1.17976L15.8202 2.82024ZM1.17976 14.1798C0.726748 14.6328 0.726748 15.3672 1.17976 15.8202C1.63276 16.2733 2.36724 16.2733 2.82024 15.8202L1.17976 14.1798ZM1.17976 2.82024L14.1798 15.8202L15.8202 14.1798L2.82024 1.17976L1.17976 2.82024ZM14.1798 1.17976L1.17976 14.1798L2.82024 15.8202L15.8202 2.82024L14.1798 1.17976Z" fill="currentColor"/>
    </svg>`)
