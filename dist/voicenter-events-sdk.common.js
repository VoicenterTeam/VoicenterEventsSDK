    ...
    return function e(t, n, r) {
      ...
      13: [function (_dereq_, module, exports) {
        (function (global) {
          ...
          function Socket(uri, opts) {
            ...
            this.onlyBinaryUpgrades = opts.onlyBinaryUpgrades; // SSL options for Node.js client
      ...
      33: [function (_dereq_, module, exports) {
        (function (global) {
          ...
          (function (root) {
            ...
            var freeExports = _typeof(exports) == 'object' && exports; // Detect free variable `module`

            var freeModule = _typeof(module) == 'object' && module && module.exports == freeExports && module; // Detect free variable `global`, from Node.js or Browserified code,
            // and use it as `root`
        ...
        (function (global) {
          ...
          exports.removeBlobs = function (data, callback) {
            function _removeBlobs(obj, curKey, containingObject) {
              ...
              } else if (obj && 'object' == _typeof(obj) && !isBuf(obj)) {
                // and object
                for (var key in obj) {
      ...
      49: [function (_dereq_, module, exports) {
        ...
        (function (window) {
          ...
          var JSON3 = _typeof(exports) == "object" && exports && !exports.nodeType && exports;
...
function () {
  function EventsSDK() {
    ...
    this._retryConnection = debounce_1(this._connect.bind(this), this.reconnectOptions.reconnectionDelay, {
      leading: true,
      trailing: false
    });
  }
  ...
  _createClass(EventsSDK, [{
    ...
    value: function _initSocketConnection() {
      ...
      this.socket = socket_io(url, _objectSpread({}, this.options, {
        debug: false
      }));
