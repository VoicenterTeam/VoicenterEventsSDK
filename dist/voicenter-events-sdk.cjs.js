      ...
      (function (e) {
        ...
        n.deconstructPacket = function (t) {
          ...
          function i(t, c, p) {
            ...
            } else if (r(t)) for (var f = 0; f < t.length; f++) i(t[f], f, t);else if (t && "object" == _typeof(t) && !o(t)) for (var h in t) i(t[h], h, t);
          }
          var s = 0,
            a = t;
          i(a), s || n(a);
      ...
      !function (e) {
        ...
        if (!n("json")) {
          ...
          if (_i = function i(t, e) {
            ...
            for (s in r) _o.call(r, s) && c++;
            return n = r = null, c ? _i = 2 == c ? function (t, e) {
              var n,
                r = {},
                i = a.call(t) == l;
              for (n in t) i && "prototype" == n || _o.call(r, n) || !(r[n] = 1) || !_o.call(t, n) || e(n);
            } : function (t, e) {
              var n,
                r,
                i = a.call(t) == l;
              for (n in t) i && "prototype" == n || !_o.call(t, n) || (r = "constructor" === n) || e(n);
          ...
          if (!n("json-parse")) {
            var P,
              ...
              L = function L(t, e, n) {
                var r,
                  o = t[e];
                if ("object" == _typeof(o) && o) if (a.call(o) == m) for (r = o.length; r--;) I(o, r, n);else _i(o, function (t) {
                  I(o, t, n);
                });
                return n.call(t, e, o);
              };
...
var EventsSDK = /*#__PURE__*/function () {
  ...
  _createClass(EventsSDK, [{
    ...
    value: function _handleTokenExpiry() {
      ...
      var maxAllowedTimeout = Math.min(timeout, 0x7FFFFFFF);
...
EventsSDK.prototype['initLogger'] = function () {
  var loggerInitOptions = Object.assign({}, this.options.loggerConfig);
  ...
  this.Logger = new StorageLogger.StorageLogger(loggerInitOptions);
};
